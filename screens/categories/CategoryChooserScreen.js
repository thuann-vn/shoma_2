...
class CategoryListScreen extends React.Component {
  static navigationOptions = ({ navigation }) => {
    ...
    renderRow(category, style = null) {
      ...
      return (
        <Swipeout key={category.id} right={swipeoutBtns} scroll={event => this._allowScroll(event)}>
...
export default connect(mapStateToProps, categoriesOperations)(CategoryListScreen);
