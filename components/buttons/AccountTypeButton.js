    ...
    render() {
        return (
            <TouchableOpacity {...this.props} style={[{ backgroundColor: this.props.color }, styles.accountType]}>
                <Image source={this.props.image} style={{width: 42, height: 42, marginTop: 10, marginBottom: 10}}></Image>
                <AvenirFormattedMessage style={styles.accountTypeName} weight="demi" message={this.props.name}/>
